...
class RecipientForm(forms.ModelForm):
    class Meta:
        model = Recipient
        fields = ("email", "last_name", "first_name", "patronymic", "comment")
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["last_name"].widget.attrs.update({"class": "form-control", "placeholder": "Введите имя"})
        self.fields["first_name"].widget.attrs.update({"class": "form-control", "placeholder": "Введите фамилию"})

...
urlpatterns = [
    ...
    path("user_list/", UserListView.as_view(), name="user_list"),  # cache_page(60)
    ...
    path("user/<int:pk>/unblock", UnblockUserView.as_view(), name="user_unblock"),
    ...
    path("set_new_password/<uid64>/<token>/", UserPasswordResetConfirmView.as_view(), name="password_reset_confirm"),
]
